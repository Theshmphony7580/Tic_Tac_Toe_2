...
('Rust', ARRAY[]::text[], 'Programming Languages', 'Technical Skills', 'Technical Skills > Programming Languages > Rust', ARRAY['Systems Programming'], 'Multi-paradigm, general-purpose programming language designed for performance and safety.'),
...
('Kotlin', ARRAY[]::text[], 'Programming Languages', 'Technical Skills', 'Technical Skills > Programming Languages > Kotlin', ARRAY['Android Development', 'Java'], 'Cross-platform, statically typed, general-purpose programming language with type inference.'),
('Swift', ARRAY[]::text[], 'Programming Languages', 'Technical Skills', 'Technical Skills > Programming Languages > Swift', ARRAY['iOS Development'], 'General-purpose, multi-paradigm, compiled programming language developed by Apple Inc.'),
('Ruby', ARRAY[]::text[], 'Programming Languages', 'Technical Skills', 'Technical Skills > Programming Languages > Ruby', ARRAY['Backend Development', 'Scripting'], 'Interpreted, high-level, general-purpose programming language.'),
...
('FastAPI', ARRAY[]::text[], 'Backend Frameworks', 'Technical Skills', 'Technical Skills > Backend Frameworks > FastAPI', ARRAY['Backend Development', 'REST API Development', 'Python'], 'A modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.'),
('Flask', ARRAY[]::text[], 'Backend Frameworks', 'Technical Skills', 'Technical Skills > Backend Frameworks > Flask', ARRAY['Backend Development', 'Web Development', 'Python'], 'A micro web framework written in Python.'),
...
('MySQL', ARRAY[]::text[], 'Databases', 'Technical Skills', 'Technical Skills > Databases > MySQL', ARRAY['SQL', 'Relational Databases'], 'An open-source relational database management system.'),
...
('Redis', ARRAY[]::text[], 'Databases', 'Technical Skills', 'Technical Skills > Databases > Redis', ARRAY['NoSQL', 'In-Memory Data Store', 'Caching'], 'An open-source (BSD licensed), in-memory data structure store, used as a database, cache, and message broker.'),
...
('Terraform', ARRAY[]::text[], 'Cloud & DevOps', 'Technical Skills', 'Technical Skills > Cloud & DevOps > Terraform', ARRAY['Infrastructure as Code', 'DevOps'], 'An open-source infrastructure as code software tool created by HashiCorp.'),
('Ansible', ARRAY[]::text[], 'Cloud & DevOps', 'Technical Skills', 'Technical Skills > Cloud & DevOps > Ansible', ARRAY['Configuration Management', 'DevOps'], 'An open-source software provisioning, configuration management, and application-deployment tool.'),
...
('PyTorch', ARRAY[]::text[], 'AI & Machine Learning', 'Technical Skills', 'Technical Skills > AI & Machine Learning > PyTorch', ARRAY['Deep Learning', 'Machine Learning', 'AI'], 'An open source machine learning framework based on the Torch library.'),
...
('LangChain', ARRAY[]::text[], 'AI & Machine Learning', 'Technical Skills', 'Technical Skills > AI & Machine Learning > LangChain', ARRAY['LLM Development', 'AI', 'Prompt Engineering'], 'A framework designed to simplify the creation of applications using large language models (LLMs).'),
('LangGraph', ARRAY[]::text[], 'AI & Machine Learning', 'Technical Skills', 'Technical Skills > AI & Machine Learning > LangGraph', ARRAY['LLM Development', 'AI', 'Agentic Workflows'], 'A library for building stateful, multi-actor applications with LLMs.'),
...
('Leadership', ARRAY[]::text[], 'Interpersonal', 'Soft Skills', 'Soft Skills > Interpersonal > Leadership', ARRAY['Management'], 'The action of leading a group of people or an organization.'),
('Communication', ARRAY['Written Communication', 'Verbal Communication'], 'Interpersonal', 'Soft Skills', 'Soft Skills > Interpersonal > Communication', ARRAY[]::text[], 'The imparting or exchanging of information or news.'),
('Problem Solving', ARRAY['Critical Thinking'], 'Cognitive', 'Soft Skills', 'Soft Skills > Cognitive > Problem Solving', ARRAY[]::text[], 'The process of finding solutions to difficult or complex issues.'),
...
('Stakeholder Management', ARRAY[]::text[], 'Management', 'Business Skills', 'Business Skills > Management > Stakeholder Management', ARRAY['Communication', 'Leadership'], 'The process of maintaining good relationships with the people who have most impact on your work.'),

-- Data & Analytics
('SQL', ARRAY[]::text[], 'Data Analysis', 'Data & Analytics', 'Data & Analytics > Data Analysis > SQL', ARRAY['Database Management'], 'A domain-specific language used in programming and designed for managing data held in a relational database management system.'),
('Data Analysis', ARRAY['Data Analytics'], 'Data Analysis', 'Data & Analytics', 'Data & Analytics > Data Analysis > Data Analysis', ARRAY[]::text[], 'A process of inspecting, cleansing, transforming, and modeling data with the goal of discovering useful information, informing conclusions, and supporting decision-making.'),
...
-- Tools & Platforms
('Git', ARRAY[]::text[], 'Version Control', 'Tools & Platforms', 'Tools & Platforms > Version Control > Git', ARRAY['Software Development'], 'Software for tracking changes in any set of files, usually used for coordinating work among programmers collaboratively developing source code during software development.'),
('GitHub', ARRAY[]::text[], 'Version Control', 'Tools & Platforms', 'Tools & Platforms > Version Control > GitHub', ARRAY['Git', 'Software Development'], 'A provider of Internet hosting for software development and version control using Git.'),
